...
JSONObjectDefinitionFileCheck | [Bug Prevention](bug_prevention_checks.md#bug-prevention-checks) | Checks if the `className` matches the pattern specified by `_classNamePattern` in `ObjectDefinitionClassNameProcessorImpl.java`. |
