...
TestClassUnnecessaryTryFinallyCheck | [Styling](styling_checks.md#styling-checks) | Finds try-finally blocks in test classes whose finally body only calls a known cleanup method. |
