...
BNDJakartaCheck | .bnd | Checks for use of Jakarta. |
...
FTLJakartaCheck | .ftl | Checks for use of Jakarta. |
...
HTMLJakartaCheck | .html or .path | Checks for use of Jakarta. |
JSJakartaCheck | .js or .jsx | Checks for use of Jakarta. |
...
JSPJakartaCheck | .jsp, .jspf, .jspx, .tag, .tpl, or .vm | Checks for use of Jakarta. |
...
JavaJakartaCheck | .java | Checks for use of Jakarta. |
...
PoshiJakartaCheck | .function, .jar, .lar, .macro, .path, .testcase, .war, or .zip | Checks for use of Jakarta. |
...
PropertiesJakartaCheck | .eslintignore, .prettierignore, or .properties | Checks for use of Jakarta. |
...
TLDJakartaCheck | .tld | Checks for use of Jakarta. |
TSJakartaCheck | .ts or .tsx | Checks for use of Jakarta. |
...
XMLJakartaCheck | .action, .function, .jelly, .jrxml, .macro, .pom, .project, .properties, .svg, .testcase, .toggle, .tpl, .wsdl, .xml, or .xsd | Checks for use of Jakarta. |
