...
----- | -------- | -----------
JSONBatchEngineDataFileCheck | [Styling](styling_checks.markdown#styling-checks) | Removes default elements and sorts by `externalReferenceCode` in `*.batch-engine-data.json` files. |
