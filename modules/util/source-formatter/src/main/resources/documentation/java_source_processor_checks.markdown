...
JavaTestGetResourceCallCheck | [Bug Prevention](bug_prevention_checks.markdown#bug-prevention-checks) | Checks that test dependencies files are located in the correct directory. |
