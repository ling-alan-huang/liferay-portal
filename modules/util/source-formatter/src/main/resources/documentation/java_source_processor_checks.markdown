...
JavaCounterIncrementMethodCheck | [Bug Prevention](bug_prevention_checks.markdown#bug-prevention-checks) | Finds counterLocalService.increment() method calls which are not recommanded. |
