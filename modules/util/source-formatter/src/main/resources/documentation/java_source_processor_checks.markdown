...
JavaModuleMissingUpgradeProcessTestCheck | [Bug Prevention](bug_prevention_checks.markdown#bug-prevention-checks) | Finds missing integration test for upgrade process. |
