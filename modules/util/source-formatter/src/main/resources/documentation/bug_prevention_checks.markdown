...
PropertiesLanguageKeysContextCheck | .eslintignore, .prettierignore or .properties | Checks that prohibiting single/double-word language keys without [context] brackets. |
