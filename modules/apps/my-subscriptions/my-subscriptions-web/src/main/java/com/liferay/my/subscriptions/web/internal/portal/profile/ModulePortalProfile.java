...
import com.liferay.my.subscriptions.web.internal.upgrade.registry.MySubscriptionsWebServiceUpgradeStepRegistrator;
...
public class ModulePortalProfile extends BaseDSModulePortalProfile {
	...
	protected void activate(ComponentContext componentContext) {
		init(
			...
			MySubscriptionsWebServiceUpgradeStepRegistrator.class.getName());
	}
