...
public abstract class BaseBookmarksEntryUADExporter
	...
	protected String toXmlString(BookmarksEntry bookmarksEntry) {
		return StringBundler.concat(
			...
			"]]></column-value></column><column><column-name>statusByUserId",
			"</column-name><column-value><![CDATA[",
			bookmarksEntry.getStatusByUserId(),
			"]]></column-value></column><column><column-name>statusByUserName",
			"</column-name><column-value><![CDATA[",
			bookmarksEntry.getStatusByUserName(),
			"]]></column-value></column><column><column-name>name",
			"</column-name><column-value><![CDATA[", bookmarksEntry.getName(),
			"]]></column-value></column><column><column-name>url",
			"</column-name><column-value><![CDATA[", bookmarksEntry.getUrl(),
			"]]></column-value></column><column><column-name>description",
			"</column-name><column-value><![CDATA[",
