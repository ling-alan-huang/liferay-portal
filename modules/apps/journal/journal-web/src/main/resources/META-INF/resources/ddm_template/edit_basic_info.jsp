...
<div class="form-group">
	...
	<div class="input-group">
		<div class="input-group-item">
			<input class="form-control lfr-input-resource" id="<portlet:namespace />ddmStructure" name="structure" placeholder="<%= LanguageUtil.format(locale, "select-x", "structure") %>" readonly value="<%= (ddmStructure != null) ? ddmStructure.getName(locale) : StringPool.BLANK %>" />
		</div>
