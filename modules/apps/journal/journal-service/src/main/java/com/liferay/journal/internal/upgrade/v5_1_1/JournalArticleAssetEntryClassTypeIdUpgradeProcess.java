	...
	protected void doUpgrade() throws Exception {
		...
		try (PreparedStatement preparedStatement1 = connection.prepareStatement(
				StringBundler.concat(
					...
					"JournalArticle where AssetEntry.classNameId = ? and (",
					"AssetEntry.classPK = JournalArticle.id_ or AssetEntry.",
					"classPK = JournalArticle.resourcePrimKey) and AssetEntry.",
