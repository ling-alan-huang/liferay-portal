...
public class BlogsEntryServiceTest {
	...
	public void testGetEntriesPrevAndNext() throws Exception {
		...
		sb.append(entry2.getEntryId());
		sb.append(" should be ");
		sb.append(entry1.getEntryId());

		Assert.assertEquals(sb.toString(), entry1, prevAndNext[0]);
		...
		Assert.assertEquals(sb.toString(), entry2, prevAndNext[1]);
		...
		sb.append(entry2.getEntryId());
		sb.append(" should be ");
		sb.append(entry3.getEntryId());

		Assert.assertEquals(sb.toString(), entry3, prevAndNext[2]);
	}
	...
	public void testGetEntriesPrevAndNextWithOnlyNext() throws Exception {
		...
		Assert.assertEquals(sb.toString(), entry1, prevAndNext[1]);
		...
		Assert.assertEquals(sb.toString(), entry2, prevAndNext[2]);
	}
