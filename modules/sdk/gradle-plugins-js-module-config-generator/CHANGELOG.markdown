...
### Commits
- [LPS-67653]: Semver gradle-plugins-js-module-config-generator (c18cc8ae8b)
...
### Commits
- [LPS-68485]: Update changelog (b81cbdda3b)
- [LPS-68485]: Semver gradle-plugins-js-module-config-generator (9439946ca7)
- [LPS-68485]: task changes files in place, safer to skip up-to-date check
(9a40009697)
- [LPS-68231]: Test plugins with Gradle 3.1 (49ec4cdbd8)
- [LPS-67352]: SF (4cdb43f575)
...
### Commits
- [LPS-68618]: Update changelog (a19ca7eb29)
...
### Commits
- [LPS-68298]: Semver gradle-plugins-js-module-config-generator (1b2fadb2d7)
- [LPS-68298]: Add option to replace "define(" in the JS files (f491e36281)

## 2.1.0 - 2016-11-03

### Commits
- [LPS-68298]: Update changelog (56d1579042)
...
### Commits
- [LPS-68298]: Update changelog (8674f302a4)
- [LPS-68298]: Fix changelog (7cd95e8901)
...
- [LPS-68405]: Update changelog (97034e1d3e)
...
### Commits
- [LPS-68405]: SF (96025c74f4)
- [LPS-68405]: Update Change Log (ae8ba6a363)
...
### Commits
- [LPS-74343]: Semver gradle-plugins-js-module-config-generator (3c06d7ade0)
...
- [LPS-68405]: Fix changelog (43bd729946)
...
### Commits
- [LPS-68298]: Fix changelog (d4603b9405)
