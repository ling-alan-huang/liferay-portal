...
- [LPS-101470]\: After changing nodeVersion, the version of node is not
correctly changed (c0d952fb13)
...
(a9d4a2ef6b)
- [LPS-91967]\: Check script file name before applying NPM arguments
(133df2f1d2)
...
### Commits
- [LPS-74933]\: Merge package.json from the root dir when publishing
(1deb5279b2)
...
- [LRDOCS-3663]\: Gradle Node plugin does not support setting the global
property via CLI (af53e8530c)
...
(711b415559)
- [LPS-67658]\: Convert gradle-plugins-node sample into a smoke test
(d4d40c57be)
...
### Commits
- [LPS-66906]\: Automatically remove .bin dirs to bypass GRADLE-1843
(65a0d0ec03)
...
- [LPS-58655]\: Convert to null if empty, so the task input validation will
throw an error (defdfdc104)
