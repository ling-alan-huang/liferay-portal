...
version 1.0.18.
- [LPS-106149]\: Update the com.liferay.gradle.plugins.poshi.runner dependency
to version 2.2.21.
- [LPS-106149]\: Update the com.liferay.gradle.plugins.whip dependency to
version 1.0.8.
...
4.1.10.
- [LPS-99977]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.37.
...
- [LPS-99774]\: Update the com.liferay.gradle.plugins dependency to version
4.1.6.
- [LPS-99774]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.36.
...
4.1.5.
- [LPS-99740]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.35.
...
### Dependencies
- [LPS-98450]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.34.
...
4.0.41.
- [LPS-96247]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.33.
...
- [LPS-84119]\: Update the com.liferay.gradle.plugins dependency to version
4.0.27.
- [LPS-93220]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.32.
...
4.0.15.
- [LPS-88909]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.31.
- [LPS-88909]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.30.
...
3.13.187.
- [LPS-94947]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.29.
...
3.13.186.
- [LPS-91967]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.28.
...
3.13.176.
- [LPS-77425]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.26.
...
3.13.157.
- [LPS-93258]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.23.
...
3.13.110.
- [LPS-90945]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.21.
...
3.13.87.
- [LPS-89916]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.20.
...
### Commits
- [LPS-89415]\: Update args (copyright.file, rest.config.file,
rest.openapi.file) (170da107c5)
...
3.13.70.
- [LPS-89436]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.19.
...
3.13.59.
- [LPS-89126]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.16.
...
3.13.56.
- [LPS-87479]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.15.
...
### Commits
- [LPS-88319]\: Include modules projects if settings.gradle is at the portal
root directory (ae535b5ab2)
...
- [LPS-88306]\: Download the NPM parent theme sources before checking the
.digest file (5ad2b99100)
...
### Commits
- [LPS-88306]\: Use NPM devDependencies to create the .digest for
subrepositories (43c2df985c)
- [LPS-88306]\: Use Gradle projects to create the .digest for portal
(99f5f78d15)
...
3.13.18.
- [LPS-85609]\: Update the com.liferay.gradle.plugins.cache dependency to
version 1.0.16.
...
version 2.0.2.
- [LPS-87466]\: Update the com.liferay.gradle.plugins.cache dependency to
version 1.0.15.
...
### Commits
- [LPS-87477]\: Lazily evaluate the property (fix for Gradle 4.10.2)
(c7338f80b3)
...
### Dependencies
- [LPS-87465]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.12.
- [LPS-87466]\: Update the com.liferay.gradle.plugins dependency to version
3.13.14.
- [LPS-87466]\: Update the com.liferay.gradle.plugins.app.javadoc.builder
...
3.13.5.
- [LPS-86576]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.11.
...
3.12.159.
- [LPS-85959]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.10.
...
- [LPS-82960]\: Revert "LPS-82960 Check '.gradle/gradle.properties'"
(054df182b8)
...
### Commits
- [LPS-82960]\: Check the root project for valid 'jira.project.keys'
(5bd8731a7c)
...
3.12.54.
- [LPS-82568]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.8.
...
version 1.0.13.
- [LPS-82310]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.7.
...
3.11.36.
- [LPS-75530]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.6.
...
version 3.1.0.
- [LPS-78741]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.5.
...
version 1.2.1.
- [LPS-77425]\: Update the com.liferay.gradle.plugins.cache dependency to
version 1.0.12.
...
3.7.3.
- [LPS-77996]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.1.
...
3.7.0.
- [LPS-77840]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 2.0.0.
...
3.6.4.
- [LPS-69802]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 1.0.3.
...
3.5.91.
- [LPS-76644]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 1.0.2.
...
3.5.79.
- [LPS-74904]\: Update the com.liferay.gradle.plugins.jsdoc dependency to
version 1.0.1.
...
- [LPS-76221]\: Update the com.liferay.gradle.plugins dependency to version
3.5.71.
- [LPS-76623]\: Update the
com.github.jk1.dependency-license-report.gradle.plugin dependency to version
0.3.11.
...
- [LPS-61099]\: Projects paths are the same, even in subrepositories
(54a09601cc)
...
- [LPS-67039]\: Embed PMD rule set file into gradle-plugins-defaults
(e9791f1cd9)
...
### Commits
- [LPS-71201]\: Block publishing tasks on master if already released
(62627f5617)
...
- [LPS-70170]\: Change taglib modules resolution during "compileJSP"
(17c8aff166)
...
### Commits
- [LPS-70335]\: Fix regression caused by
...
- [LPS-67863]\: Sync bundle and package versions with release branch
(565c87aad4)
