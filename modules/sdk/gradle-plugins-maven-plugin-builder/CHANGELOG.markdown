...
### Commits
- [LPS-67986]: Update changelog (f7aad2ccdb)
...
### Commits
- [LPS-71087]: Semver gradle-plugins-maven-plugin-builder (9ad2318418)
...
(4ff2bb6038)
- [LPS-67986]: Very minor change log edits, for consistency (3c898841a4)

## 1.1.0 - 2017-03-08

### Commits
- [LPS-71087]: Update changelog (831e6d207b)
...
### Commits
- [LPS-71264]: Update changelog (8467a19eea)
- [LPS-71264]: Pass Maven repo local dir when building plugin descriptors
(13961ec196)
- [LPS-71087]: Fix changelog (9aa275575d)
...
### Commits
- [LPS-71264]: Semver gradle-plugins-maven-plugin-builder (3293c7f1b4)
...
- [LPS-71264]: Update changelog (4bae928303)
- [LPS-76644]: Enable Gradle plugins publishing (8bfdfd53d7)
- [LPS-76644]: Add description to Gradle plugins (5cb7b30e6f)
- [LPS-73525]: It's always "Add the ability..." in changelogs (d5489e2aac)
- [LPS-71164]: Avoid SF autofix (8bcb08cde7)
- []: Revert "LPS-71164 Auto SF" (ce30c4bb21)
- [LPS-71164]: Auto SF (adc49fe774)
...
- [LPS-71264]: Update changelog (942b377557)
...
### Commits
- [LPS-84213]: Update changelog (c96ebbad3b)
