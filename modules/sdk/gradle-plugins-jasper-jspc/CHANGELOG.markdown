...
### Commits
- [LPS-51081]\: Split the classpath in 2 different configurations, so they can
be assembled in the correct order: the Jasper JspC jars must come first
(c19e98e8aa)
...
- [LPS-51081]\: Skip the JSP compilation if there are no JSP files in the
project (7bc515dd8d)
