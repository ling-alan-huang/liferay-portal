...
- [LPS-55937]\: Follow RevWalk javadoc's advice to use parseCommit()
(cee71a2b3b)
...
- [LPS-55937]\: Since we don't use git submodule at all, let's ignore it to
speed things up. (36716e688a)
