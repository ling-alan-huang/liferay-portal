...
(699d07b2e4)
- [LPS-62986]\: Add shortcut configuration to specify the test names
(7c9d71da7d)
...
### Commits
- [LRQA-17405]\: add a line break since we declared closure for just this
method. Please apply else where (d7c142f1f0)
