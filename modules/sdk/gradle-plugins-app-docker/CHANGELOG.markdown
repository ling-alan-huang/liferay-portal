...
### Commits
- [LPS-74785]: Update changelog (c22bd66d2d)
- [LPS-74785]: Avoid failing the build if Git throws an error (43aeb3737d)
- [LPS-72870]: Semver gradle-plugins-app-docker (eab7ccbf20)
...
- [LPS-74811]: Update changelog (5caf1b755a)
...
### Commits
- [LPS-75327]: Update changelog (e571864318)
- [LPS-75327]: Automatically fix line endings of .sh files (82ee1acba1)
- [LPS-73070]: Minor changelog wordsmithing (fa6a436134)
...
### Commits
- [LPS-75704]: Update changelog (e68e630a0f)
...
### Commits
- [LPS-86588]: Update changelog (f7f7d26691)
...
- [LPS-84094]: Fix changelog (023d60773f)
- [LPS-86588]: Fix changelog (f7d0b6875e)
...
- [LPS-86875]: Fix changelog (5086bb7605)
- [LPS-86875]: Update changelog (4ea9202170)
