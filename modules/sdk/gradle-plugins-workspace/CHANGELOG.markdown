...
- [LPS-110131]\: add new test for asserting correct patching behavior
(e41df06c73)
...
- [LPS-109787]\: Configurations from specific environments should be copied
after common configurations (df5b40d55f)
...
### Dependencies
- [LPS-106149]\: Update the com.liferay.gradle.plugins.target.platform
dependency to version 2.1.3.

## 2.2.7 - 2020-02-25

### Dependencies
- [LPS-109312]\: Update the com.liferay.gradle.plugins.target.platform
...
- [LPS-107862]\: test multiple script and assert that "other" is executed and
not "local" (6b3d9e52fd)
...
### Dependencies
- [LPS-107155]\: Update the com.liferay.gradle.plugins.target.platform
...
### Dependencies
- [LPS-105889]\: Update the com.liferay.gradle.plugins.target.platform
dependency to version 2.0.8.

## 2.2.2 - 2019-12-24

### Dependencies
- [LPS-105502]\: Update the com.liferay.gradle.plugins.target.platform
...
- [LPS-103937]\: we don't need the scripts folder in Dockerfile, we can create
it in setup.sh (c917cd2813)
...
(4b4974e593)
- [LPS-103937]\: enable remote java debugging for created containers
(0790b00000)
...
- [LPS-103937]\: improve removeDockerContainer task to use new
workspaceExtension field for container id (36645a9e70)
...
### Dependencies
- [LPS-100515]\: Update the com.liferay.gradle.plugins.target.platform
...
### Dependencies
- [LPS-104540]\: Update the com.liferay.gradle.plugins.target.platform
...
### Dependencies
- [LPS-100335]\: Update the com.liferay.gradle.plugins.target.platform
...
- [LPS-99382]\: Use final when the variable is used inside a closure
(7fd763aa6d)
...
- [LPS-97550]\: Use final when the variable is used inside a closure
(434f5d2480)
...
version 2.2.13.
- [LPS-97601]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.7.
...
4.0.13.
- [LPS-94999]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.7.
- [LPS-84119]\: Update the com.liferay.gradle.plugins dependency to version
4.0.12.
- [LPS-84119]\: Update the com.liferay.gradle.plugins dependency to version
...
### Commits
- [LPS-84119]\: Revert "LPS-84119 Use LocaleUtil instead of Locale when
possible" (648a6b5d96)
...
### Dependencies
- [LRQA-46662]\: Update the com.liferay.gradle.plugins.target.platform
dependency to version 1.1.11.
...
3.13.6.
- [LPS-86581]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.5.
...
- [LPS-84055]\: Update the com.liferay.gradle.plugins dependency to version
3.12.97.
- [LPS-83755]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.4.
- [LPS-74544]\: Update the com.liferay.gradle.plugins dependency to version
3.12.96.
...
to version 1.0.0.
- [LPS-77425]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.3.
...
### Dependencies
- [LPS-76271]\: Update the com.liferay.gradle.plugins.theme.builder dependency
to version 2.0.3.
- [LPS-76221]\: Update the com.liferay.gradle.plugins dependency to version
3.5.57.
...
- [LPS-74818]\: Check directly from "downloadBundle" property values
(617f71239f)
- [LPS-74818]\: Avoid NPE is bundle URL does not point to a local file
(4cbb9318bc)
- [LPS-74818]\: Configure both properties via Gradle for consistency
(ad14ff3aa8)
...
- [LPS-73913]\: Make Gradle check if the password file exists or not
(1fa8a15149)
...
(a9b3fe8ffc)
- [LPS-69294]\: Test if themes are correctly added to the bundle ZIP
(bbb3b7d1c2)
...
(4de0c41576)
- [LPS-68849]\: Allow to overwrite bundle files via the "config" dir
(7dc0de964d)
...
- [LPS-61767]\: Add task description (copied from LiferayJavaPlugin)
(ce8e04c99f)
...
- [LPS-61767]\: Convert to a "settings" plugin, this way we can remove
everything from settings.gradle (b4be4c57fd)
