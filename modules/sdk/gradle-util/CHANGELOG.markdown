...
### Commits
- [LPS-51081]\: Copy RenameDependencyClosure to gradle-util, so it can be used
by Gradle scripts (d6992be0e0)
...
- [LPS-55187]\: Clean test outputs before running it again in order to bypass
the up-to-date check (59fd9e696c)
