...
### Commits
- [LPS-69271]\: Remove logic to check for missing @Override from
JavaDocFormatter (4924d0dc4a)
...
- [LPS-67658]\: Convert gradle-plugins-javadoc-formatter sample into a smoke
test (109457db28)
