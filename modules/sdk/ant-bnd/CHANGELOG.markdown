...
- [LPS-84119]\: Clean up source-formatter-suppressions.xml on master
(7e3ee2c759)
...
### Commits
- [LPS-87839]\: Check when there's no difference but the packageinfo versions
are not equal (ba40d0f962)
...
### Commits
- [LPS-87776]\: Allow the baseline task to update the Bundle-Version when all
the packageinfo files are correct (c844c0296a)
...
- [LPS-85678]\: Move check into isIgnoredWarnings (no logic changes)
(69500dbedf)
...
### Dependencies
- [LPS-75049]\: Update the com.liferay.portal.impl dependency to version
default.
...
- [LPS-74110]\: baseline recommends MAJOR bundle version change when only
changes are moved packages (23d3dd8d76)
...
### Commits
- [LPS-76997]\: Change ServiceAnalyzerPlugin to read version from spring
extender api (8d3a3a5f2f)
...
- [LPS-76926]\: Fixing the tests and a new one for range of
requireSchemaVersions (598797e531)
...
- [LPS-76224]\: don't add package imports for page imports that are commented
out (17b4162b62)
...
### Commits
- [LPS-74110]\: Revert "LPS-74110 baseline recommends MAJOR bundle version
change when only changes are moved packages" (06f33ace90)
...
- [LPS-74110]\: baseline recommends MAJOR bundle version change when only
changes are moved packages (30a4d749c1)
- [LPS-73481]\: Creating DTDs for 7.1.0 and apply them in XML files.
(15f47d7471)
...
### Dependencies
- [LPS-73481]\: Update the com.liferay.portal.impl dependency to version
default.
...
- [LPS-71118]\: add caching to jspAnalazyerPlugin to avoid continually looking
up the same tag lig requirements (6fb16379e2)
...
### Commits
- [LPS-69899]\: Add option to merge the compat jar before baselining
(91f8123a60)
...
### Commits
- [LRQA-25824]\: Fail baseline if packageinfo for a new package is missing, or
if packageinfo for a removed package can still be found (68740d4be2)
...
### Dependencies
- [LPS-65283]\: Update the com.liferay.portal.impl dependency to version
default.
