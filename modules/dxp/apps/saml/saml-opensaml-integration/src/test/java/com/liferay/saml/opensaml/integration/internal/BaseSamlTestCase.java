...
public abstract class BaseSamlTestCase {
	...
	protected static final String ACS_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/saml/acs";
	...
	protected static final String LOGIN_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/login";

	protected static final String LOGOUT_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/logout";

	protected static final String METADATA_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/saml/metadata";

	protected static final String PORTAL_URL = "http://localhost:" + PortalUtil.getPortalServerPort(false) + "";

	protected static final String RELAY_STATE =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/relaystate";

	protected static final long SESSION_ID = 2;

	protected static final String SLO_LOGOUT_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/saml/slo_logout";

	protected static final String SP_ENTITY_ID = "testsp";

	protected static final String SSO_URL =
		"http://localhost:" + PortalUtil.getPortalServerPort(false) + "/c/portal/saml/sso";
