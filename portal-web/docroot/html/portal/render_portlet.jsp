...
<c:if test="<%= renderPortletBoundary %>">
	...
	<div class="<%= cssClasses %>" id="p_p_id<%= HtmlUtil.escapeAttribute(liferayPortletResponse.getNamespace()) %>">
	...
	Liferay.Portlet.onLoad(
		{
			...
			columnPos: <%= columnPos %>,
			isStatic: '<%= staticVar %>',
			namespacedId: 'p_p_id<%= HtmlUtil.escapeJS(liferayPortletResponse.getNamespace()) %>',
